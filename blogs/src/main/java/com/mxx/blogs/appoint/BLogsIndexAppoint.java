...
public class BLogsIndexAppoint {
    ...
    public static SystemResult checkCookieUser(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String cookieValue = CookieUtils.getCookieValue(request, UserContants.USER_KEY);
        //查cookie
